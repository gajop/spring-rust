...
pub(crate) mod bindings {
    pub(crate) mod recoil {
        ...
        pub(crate) mod unit_defs {
            pub(crate) use spring_wasm_core::owned::unit_defs::{get_unit_def_costs, get_unit_def_count, get_unit_def_health, get_unit_def_i_ds, get_unit_def_id_by_name, get_unit_def_speed, valid_unit_def_id};
        }
