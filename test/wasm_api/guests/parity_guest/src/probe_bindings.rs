...
pub(crate) mod bindings {
    pub(crate) mod recoil {
        ...
        pub(crate) mod units_query {
            pub(crate) use spring_wasm_core::owned::units_query::{Float3, GetClosestEnemyUnitOptions, GetUnitNearestEnemyOptions, GetUnitSeparationOptions, get_all_units, get_closest_enemy_unit, get_team_unit_count, get_team_unit_def_count, get_team_units, get_unit_nearest_ally, get_unit_nearest_enemy, get_unit_separation, valid_unit_id};
        }
