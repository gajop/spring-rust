...
[GAME]
{
	...
	FixedUnsyncedRNGSeed = 1; // Initialize the unsynced RNG (particles, CEGs, sounds, ...) with a specific seed, eg. for comparing screenshots in tests. Only exact if the frames drawn are the same.
