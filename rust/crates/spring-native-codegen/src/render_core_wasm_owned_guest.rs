...
fn handwritten_signature_override(module: &str, function: &str) -> Option<&'static str> {
    match (module, function) {
        ...
        ("profiling", "GetTimer") => Some("->i64"),
        ("profiling", "GetTimerMicros") => Some("->i64"),
        ("profiling", "DiffTimers") => Some("i64,i64,i32,i32->i64"),
        ("profiling", "GetFrameTimer") => Some("i32->i64"),
        ("profiling", "GetDrawSeconds") => Some("->i64"),
        ("profiling", "GetLuaMemUsage") => Some("i32->i32"),
        ("profiling", "GetVidMemUsage") => Some("i32->i32"),
