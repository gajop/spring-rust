//! Generate the Rust guest-facing Core ABI layer. The first generated layer is
//! intentionally small and trustworthy: every executable import is declared in
//! `raw`, while safe wrappers are emitted automatically for direct scalar/enum/
//! handle calls. Fixed/variable wrappers can be layered on the same generated
//! raw surface without exposing descriptors to normal guest code.
...
pub fn render(model: &ApiModel) -> String {
    ...
    let mut output = String::from(
        "// @generated by spring-api-codegen; do not edit.\n\n\
         ...
         // for advanced/benchmark use; ordinary guest code should use the safe\n\
         // wrappers generated alongside them or the specialized crate APIs.\n\n",
    );
...
fn executable(
    ...
    fixed_executable(plan, inputs, outputs, records)
        ...
        || render_core_wasm_variable_host::eligible(plan, inputs, outputs, records)
