...
use crate::{render_core_wasm_dynamic_input_host, render_core_wasm_owned_guest};
...
pub fn render_cpp(model: &ApiModel) -> String {
    ...
    for module in &model.modules {
        for function in &module.functions {
            ...
            callbacks.push('\n');
            // The owned SDK never routes to Variable — it uses either
            // borrowed or dynamic_input.  Skip registration when either
            // of those covers this import.
