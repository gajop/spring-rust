...
- `Spring.SetHeightMapFunc` (params: luaFunction:LuaFunctionRef, arg:number, args:NativeLuaArgs)
...
- `Spring.SetOriginalHeightMapFunc` (params: heightMapFunc:LuaFunctionRef)
...
- `Spring.SetSmoothMeshFunc` (params: luaFunction:LuaFunctionRef, arg:NativeLuaValue, args:NativeLuaArgs)
