...
- `RmlUi.Context.AddEventListener` (params: event:string, listener:function|string, in_capture_phase:boolean)
...
- `RmlUi.Element.IsPointWithinElement` (params: point:RmlUi.Vector2f)
