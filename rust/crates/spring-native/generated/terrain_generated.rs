impl<'a> Terrain<'a> {
    ...
    pub fn get_ground_info(&self, x: f32, z: f32) -> Result<(i32, Option<String>, f32, f32, f32, f32, f32, f32, bool), Error> {
        unsafe {
    ...
    pub fn get_terrain_type_data(&self, terrain_type_index: i32) -> Result<(i32, Option<String>, f32, f32, f32, f32, f32, bool), Error> {
        unsafe {
    ...
    pub fn get_ground_extremes(&self) -> Result<(f32, f32, f32, f32), Error> {
        unsafe {
