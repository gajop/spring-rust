...
COUNTERPARTS: dict[tuple[str, str], tuple[str, ...]] = {
    ...
    ("RBO", "target"): ("Gfx.get_rboinfo.target",),
    ("RBO", "format"): ("Gfx.get_rboinfo.format",),
    ("RBO", "xsize"): ("Gfx.get_rboinfo.xsize",),
    ("RBO", "ysize"): ("Gfx.get_rboinfo.ysize",),
    ("RBO", "samples"): ("Gfx.get_rboinfo.samples",),
    ("RBO", "valid"): ("Gfx.get_rboinfo.valid",),
