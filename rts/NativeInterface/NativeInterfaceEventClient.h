...
namespace fptr {
	...
	using ScreenCallinFuncPtr = DrawScreenFuncPtr;
	using MiniMapDrawFuncPtr = void(*)(NativeInterface*, void*, const MiniMapDrawQuery*, SimpleCallinResult*);
	...
	using DrawScreenEffectsFuncPtr = ScreenCallinFuncPtr;
	using DrawScreenPostFuncPtr = ScreenCallinFuncPtr;
	using DrawInMiniMapFuncPtr = MiniMapDrawFuncPtr;
	using DrawInMiniMapBackgroundFuncPtr = MiniMapDrawFuncPtr;
...
private:
	...
	fptr::ScreenCallinFuncPtr m_DrawScreenEffectsFuncPtr = nullptr;
	fptr::ScreenCallinFuncPtr m_DrawScreenPostFuncPtr = nullptr;
	fptr::MiniMapDrawFuncPtr m_DrawInMiniMapFuncPtr = nullptr;
	fptr::MiniMapDrawFuncPtr m_DrawInMiniMapBackgroundFuncPtr = nullptr;
