...
struct GfxTexGenQuery { uint32_t target; bool setState; bool state; uint32_t pname; float values[4]; uint32_t count; };
struct GfxMultiTexGenQuery { int32_t texNum; uint32_t target; bool setState; bool state; uint32_t pname; float values[4]; uint32_t count; };
struct GfxLightQuery { int32_t light; bool setState; bool state; uint32_t pname; float values[4]; uint32_t count; };
...
struct GfxSaveImageQuery { int32_t x; int32_t y; int32_t width; int32_t height; const char* filename; bool alpha; bool yflip; bool grayscale16bit; uint32_t readBuffer; };
...
struct GfxFontSubmitBufferedQuery { uint32_t fontID; bool noBillboarding; bool userDefinedBlending; };
...
struct GfxUnitDrawQuery { int32_t unitID; bool applyTransform; bool doRawDraw; bool noLuaCall; bool fullModel; };
struct GfxFeatureDrawQuery { int32_t featureID; bool applyTransform; bool doRawDraw; bool noLuaCall; };
struct GfxObjectTextureStateQuery { int32_t objectID; bool push; };
struct GfxObjectShapeQuery { int32_t defID; int32_t teamID; bool rawState; bool toScreen; bool opaque; };
...
struct GfxDepthTestQuery { bool enable; bool setFunc; uint32_t func; };
...
struct GfxColorMaskQuery { bool red; bool green; bool blue; bool alpha; };
