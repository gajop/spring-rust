    pub mod lights {
        ...
        pub fn add_map_light(params: &LightParams) -> Result<u32> {
            let value = crate::generated::lights::add_map_light(crate::generated::lights::LightParams { position: { let __values = &params.position[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, direction: { let __values = &params.direction[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, ambient_color: { let __values = &params.ambient_color[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, diffuse_color: { let __values = &params.diffuse_color[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, specular_color: { let __values = &params.specular_color[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, intensity_weight: { let __values = &params.intensity_weight[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, attenuation: { let __values = &params.attenuation[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, ambient_decay_rate: { let __values = &params.ambient_decay_rate[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, diffuse_decay_rate: { let __values = &params.diffuse_decay_rate[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, specular_decay_rate: { let __values = &params.specular_decay_rate[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, decay_function_type: { let __values = &params.decay_function_type[..]; if __values.len() > 3 { return Err(crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32)); } let mut __array = [0 as f32; 3]; __array[..__values.len()].copy_from_slice(__values); __array }, radius: params.radius, fov: params.fov, ttl: params.ttl, priority: params.priority, ignore_los: params.ignore_los, local_space: params.local_space })?;
            Ok(value)
        }
