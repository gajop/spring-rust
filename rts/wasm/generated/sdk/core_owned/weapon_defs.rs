    pub mod weapon_defs {
        ...
        mod __core_variable_output_get_weapon_def_name {
            ...
            unsafe extern "C" {
                ...
                pub safe fn call(pweapon_def_id: i32, output: i32) -> i32;
            }
        }
        ...
        pub fn get_weapon_def_i_ds(unused: u8) -> Result<Vec<i32>> {
            #[cfg(target_arch = "wasm32")]
            {
                ...
                loop {
                    ...
                    let status = __core_variable_output_get_weapon_def_i_ds::call(unused as i32, descriptor_ptr);
        ...
        pub fn get_weapon_def_name(weapon_def_id: i32) -> Result<String> {
            #[cfg(target_arch = "wasm32")]
            {
                ...
                loop {
                    ...
                    descriptor[0] = output_ptr as u32;
                    descriptor[1] = output_capacity as u32;
                    let status = __core_variable_output_get_weapon_def_name::call(weapon_def_id, descriptor_ptr);
                    let required = descriptor[2] as usize;
                    if status == 0 {
                        output.truncate(required);
