    pub mod feature_control {
        ...
        #[inline]
        pub fn set_feature_piece_matrix(feature_id: i32, piece_index: i32, matrix: &Vec<f32>) -> Result<bool> {
            let value = crate::generated::feature_control::set_feature_piece_matrix(feature_id, piece_index, matrix.clone().try_into().map_err(|_| crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32))?)?;
            Ok(value)
        }
