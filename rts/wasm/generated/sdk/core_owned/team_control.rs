    pub mod team_control {
        ...
        pub fn add_team_resource(team_id: i32, resource_type: &str, amount: f32) -> Result<bool> {
            ...
            crate::generated::borrowed::team_control::add_team_resource(team_id, &resource_type_cstr, amount)
        }
        ...
        pub fn add_team_resource_excess_stats(team_id: i32, resource_type: &str, amount: f32) -> Result<bool> {
            ...
            resource_type_bytes.push(0);
            let resource_type_cstr = core::ffi::CStr::from_bytes_with_nul(&resource_type_bytes).map_err(|_| crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32))?;
            crate::generated::borrowed::team_control::add_team_resource_excess_stats(team_id, &resource_type_cstr, amount)
        }
        ...
        #[inline]
        pub fn game_over(winning_ally_teams: &Vec<i32>) -> Result<bool> {
            crate::generated::borrowed::team_control::game_over(winning_ally_teams.as_slice())
        }
        ...
        pub fn set_team_resource(team_id: i32, resource_type: &str, amount: f32) -> Result<bool> {
            ...
            resource_type_bytes.push(0);
            let resource_type_cstr = core::ffi::CStr::from_bytes_with_nul(&resource_type_bytes).map_err(|_| crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32))?;
            crate::generated::borrowed::team_control::set_team_resource(team_id, &resource_type_cstr, amount)
        }
        ...
        pub fn set_team_share_level(team_id: i32, resource_type: &str, share_level: f32) -> Result<bool> {
            ...
            resource_type_bytes.push(0);
            let resource_type_cstr = core::ffi::CStr::from_bytes_with_nul(&resource_type_bytes).map_err(|_| crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32))?;
            crate::generated::borrowed::team_control::set_team_share_level(team_id, &resource_type_cstr, share_level)
        }
        ...
        pub fn share_team_resource(team_id: i32, target_team_id: i32, resource_type: &str, amount: f32) -> Result<bool> {
            ...
            resource_type_bytes.push(0);
            let resource_type_cstr = core::ffi::CStr::from_bytes_with_nul(&resource_type_bytes).map_err(|_| crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32))?;
            crate::generated::borrowed::team_control::share_team_resource(team_id, target_team_id, &resource_type_cstr, amount)
        }
        ...
        pub fn use_team_resource(team_id: i32, resource_type: &str, amount: f32) -> Result<bool> {
            ...
            resource_type_bytes.push(0);
            let resource_type_cstr = core::ffi::CStr::from_bytes_with_nul(&resource_type_bytes).map_err(|_| crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32))?;
            crate::generated::borrowed::team_control::use_team_resource(team_id, &resource_type_cstr, amount)
        }
