    pub mod cob_script {
        ...
        pub fn get_cob_script_id(unit_id: i32, func_name: &str) -> Result<i32> {
            ...
            let func_name_cstr = core::ffi::CStr::from_bytes_with_nul(&func_name_bytes).map_err(|_| crate::ApiError::new(crate::ErrorCode::InvalidArgument as i32))?;
            crate::generated::borrowed::cob_script::get_cob_script_id(unit_id, &func_name_cstr)
        }
