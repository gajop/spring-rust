    pub mod unsynced_ctrl {
        ...
        pub fn stop_tracking_units(unused: u8) -> Result<bool> {
            let value = crate::generated::unsynced_ctrl::stop_tracking_units(unused)?;
            Ok(value)
        }

        #[inline]
        pub fn track_units(unit_i_ds: &[i32], mode: i32) -> Result<bool> {
            crate::generated::borrowed::unsynced_ctrl::track_units(unit_i_ds, mode)
        }
